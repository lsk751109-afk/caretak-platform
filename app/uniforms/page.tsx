...
const products = [
  ...
  { name: "케어택 하의", english: "CARE PANTS", tone: "딥 네이비", description: "현장 활동에 편안한 움직임과 단정한 인상을 고려한 간병인용 하의입니다.", sizes: "사이즈 문의", price: "44,000원" },
